...
| 首启向导 | 首页 | 做饭结果 | 技术面板 |
|---|---|---|---|
| ![首启向导](docs/screenshots/01-首启向导.png) | ![首页](docs/screenshots/02-首页.png) | ![做饭结果](docs/screenshots/03-做饭结果.png) | ![技术面板](docs/screenshots/04-技术面板.png) |

> 以上截图取自 Android 36 模拟器上的真实运行，非设计稿。技术面板里的
> 「食材识别 577 ms / 动作生成 2.44 s」来自服务端返回的 `meta.stages`，是真实测量值。
